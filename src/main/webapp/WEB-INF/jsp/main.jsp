    ...
    <div id="nav">
        <ul id="hul">
            ...
            <li><a href="http://www.w3schools.com/css/css3_intro.asp">CSS3</a>
                <ul>
                    <li><a href="http://tutorialzine.com/2013/10/12-awesome-css3-features-you-can-finally-use/">CSS3 New
                        Features</a></li>
                    <li><a href="https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Media_queries">CSS3 Media
                        Queries</a></li>
                    <li><a href="https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Using_CSS_animations">CSS3
                        Animation</a></li>
                </ul>
            </li>
            <li><a href="http://www.w3schools.com/js/">Javascirpt</a>
                <ul>
                    ...
                    <li>
                        <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Details_of_the_Object_Model">JS
                            Object Model</a></li>
                    <li><a href="https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Introduction">JS
                        DOM Basics</a></li>
                    <li><a href="http://code.tutsplus.com/tutorials/javascript-and-the-dom-series-lesson-1--net-3134">JS
                        DOM Tutorial</a></li>
            ...
            <li><a href="http://www.w3schools.com/angular/default.asp">AngularJS</a>
                <ul>
                    ...
                    <li><a href="http://www.toptal.com/angular-js/a-step-by-step-guide-to-your-first-angularjs-app">AngularJS
                        Tutorial 4</a></li>
                    <li><a href="https://thinkster.io/angulartutorial/mean-stack-tutorial/">AngularJS Tutorial 5</a>
                    </li>
                </ul>
            </li>
            <li><a href="http://newrelic.com/devops/toolset">DevOps</a>
                <ul>
                    ...
                    <li>
                        <a href="http://developerblog.redhat.com/2014/05/15/practical-introduction-to-docker-containers/">Docker
                            Tutorial 1</a></li>
                    <li><a href="http://blog.flux7.com/blogs/docker/docker-tutorial-series-part-1-an-introduction">Docker
                        Tutorial 2</a></li>
            ...
            <li><a href="http://nodejs.org/">Node.js</a>
                <ul>
                    ...
                    <li><a href="http://www.toptal.com/nodejs/why-the-hell-would-i-use-node-js">Node.js Tutorial 2</a>
                    </li>
            ...
            <li><a href="http://nosql-database.org/">NoSQL</a>
                <ul>
                    <li><a href="http://openmymind.net/2011/11/8/Redis-Zero-To-Master-In-30-Minutes-Part-1/">Redis</a>
                    </li>
            ...
            <li><a href="http://www.comtechies.com/2013/02/cloud-computing-tutorials-for-beginers.html">Cloud</a>
                <ul>
                    <li><a href="https://www.udemy.com/amazon-web-services-for-web-hosting-cloud-computing/">AWS
                        Video</a></li>
            ...
            <li><a href="http://www.linux.org/">Linux</a>
                <ul>
                    ...
                    <li><a href="https://www.linode.com/docs/tools-reference/linux-system-administration-basics">Linux
                        Admin Basics</a></li>
            ...
            <li><a href="http://searchstorage.techtarget.com/guides/Big-data-tutorial-Everything-you-need-to-know">BigData</a>
                <ul>
                    ...
                    <li><a href="http://aisel.aisnet.org/cgi/viewcontent.cgi?article=3785&context=cais">Big Data
                        Concepts</a></li>
                </ul>
            </li>
            ...
            <li><a href="https://developer.mozilla.org/en-US/docs/Web/Guide/Mobile">Mobile</a>
                <ul>
                    <li><a href="https://developer.mozilla.org/en-US/docs/Web_Development/Responsive_Web_design">Responsive
                        Design</a></li>
                    <li><a href="http://developer.android.com/guide/components/fundamentals.html">Android
                        Fundamentals</a></li>
                    ...
                    <li><a href="http://www.smashingmagazine.com/guidelines-for-mobile-web-development/">Mobile Web
                        Guidelines</a></li>
                </ul>
            </li>
        </ul>
